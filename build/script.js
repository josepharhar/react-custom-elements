...
prettifyTable(table);
{
  ...
  const [stable, patched, preact] = renderAllFrameworks(function () {
    h("my-custom-element", {
...
addRenderToStringTest(`<my-custom-element htmlFor="foo" />`, function () {
  h("my-custom-element", {
    htmlFor: "foo"
  });
});
addRenderToStringTest(`<div htmlFor="foo" />`, function () {
  h("div", {
    htmlFor: "foo"
  });
});
addRenderToStringTest(`<my-custom-element for="foo" />`, function () {
  h("my-custom-element", {
    for: "foo"
  });
});
...
addRenderToStringTest(`<my-custom-element className="foo" />`, function () {
  h("my-custom-element", {
    className: "foo"
  });
});
addRenderToStringTest(`<div className="foo" />`, function () {
  h("div", {
    className: "foo"
  });
});
addRenderToStringTest(`<my-custom-element class="foo" />`, function () {
  h("my-custom-element", {
    class: "foo"
  });
});
...
addRenderToStringTest(`<my-custom-element attr={true} />`, function () {
  h("my-custom-element", {
    attr: true
  });
});
addRenderToStringTest(`<div attr={true} />`, function () {
  h("div", {
    attr: true
  });
});
addRenderToStringTest(`<my-custom-element attr={['one', 'two']} />`, function () {
  h("my-custom-element", {
    attr: ['one', 'two']
  });
});
addRenderToStringTest(`<div attr={['one', 'two']} />`, function () {
  h("div", {
    attr: ['one', 'two']
  });
});
addRenderToStringTest(`<my-custom-element attr={{property: 'value'}} />`, function () {
  h("my-custom-element", {
    attr: {
      property: 'value'
    }
...
addRenderToStringTest(`<div attr={{property: 'value'}} />`, function () {
  h("div", {
    attr: {
      property: 'value'
    }
...
addRenderToStringTest(`<div onClick="foo" />`, function () {
  h("div", {
    onClick: "foo"
  });
});
addRenderToStringTest(`<div onClickCapture="foo" />`, function () {
  h("div", {
    onClickCapture: "foo"
  });
});
...
addRenderToStringTest(`<div onClick={() => console.log('foo')} />`, function () {
  h("div", {
    onClick: () => console.log('foo')
  });
});
addRenderToStringTest(`<div onCustomEvent={() => console.log('foo')} />`, function () {
  h("div", {
    onCustomEvent: () => console.log('foo')
  });
});
addRenderToStringTest(`<my-custom-element onClick="foo" />`, function () {
  h("my-custom-element", {
    onClick: "foo"
  });
});
addRenderToStringTest(`<my-custom-element onClickCapture="foo" />`, function () {
  h("my-custom-element", {
    onClickCapture: "foo"
  });
});
...
addRenderToStringTest(`<my-custom-element onClick={() => console.log('foo')} />`, function () {
  h("my-custom-element", {
    onClick: () => console.log('foo')
  });
});
addRenderToStringTest(`<my-custom-element onCustomEvent={() => console.log('foo')} />`, function () {
  h("my-custom-element", {
    onCustomEvent: () => console.log('foo')
  });
});
addRenderToStringTest(`<my-custom-element onCustomEvent="foo" />`, function () {
  h("my-custom-element", {
    onCustomEvent: "foo"
  });
});
addRenderToStringTest(`<my-custom-element onCustomEventCapture="foo" />`, function () {
  h("my-custom-element", {
