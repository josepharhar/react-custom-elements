...
(function (global, factory) {
  ...
  function getPropertyInfo(name, node, isCustomComponentTag) {
    if (properties.hasOwnProperty(name)) {
      return properties[name];
    }

    if (isCustomComponentTag && node && name in node) {
      var acceptsBooleans = typeof node[name] === 'boolean';
      return {
        acceptsBooleans: acceptsBooleans,
  ...
  function createMarkupForProperty(name, value, isCustomComponent) {
    var propertyInfo = getPropertyInfo(name, undefined, isCustomComponent);
  ...
  function createOpenTagMarkup(tagVerbatim, tagLowercase, props, namespace, makeStaticMarkup, isRootElement) {
    ...
    for (var propKey in props) {
      ...
      var markup = createMarkupForProperty(propKey, propValue, isCustomComponent$1);
